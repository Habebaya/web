...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          OurService(serviceContent: homeModel,useDummy: true,),
          const DividerImage(),
          Offering(
            homeModel: homeModel,
          ),
           Engagement(engagementContent: homeModel,),
           Clients(clientsContent: homeModel,),
          Technology(technologyContent: homeModel,),
          BoundarySection(boundaryContent: homeModel,),
        ],
      ),
    );
  }
